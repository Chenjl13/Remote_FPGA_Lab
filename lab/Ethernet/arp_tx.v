    ...
    begin
        ...
        begin
            case(arp_send_cnt)
                ...
                16'd12  :  arp_tx_data <= MAC_TYPE[15:8]          ;     
                16'd13  :  arp_tx_data <= MAC_TYPE[7:0]           ;
                16'd14  :  arp_tx_data <= HARDWARE_TYPE[15:8]     ;      
                16'd15  :  arp_tx_data <= HARDWARE_TYPE[7:0]      ;
                16'd16  :  arp_tx_data <= PROTOCOL_TYPE[15:8]     ;      
                16'd17  :  arp_tx_data <= PROTOCOL_TYPE[7:0]      ;
                16'd18  :  arp_tx_data <= MAC_LENGTH              ;      
                16'd19  :  arp_tx_data <= IP_LENGTH               ;     
