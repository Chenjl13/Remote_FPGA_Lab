...
module udp_tx #(
    ...
    input wire         udp_send_clk,                                                                                                                                                                                                                                                                                                                                                                    
    input wire         rstn,                                                                                                                                                                                                                                                                                                                                                              
                                                                                                                                                                                                                                                                                                                                                                                                                    
    //from software app                                                                                                                                                                                                                                                                                                                                                                                             
    input wire         app_data_in_valid,                                                                                                                                                                                                                                                                                                                    
    input wire [7:0]   app_data_in,                                                                                                                                                                                                                                                                                                                                          
    input wire [15:0]  app_data_length,                                                                                                                                                                                                                                                                                               
    input wire [15:0]  udp_dest_port,                                                                                                                                                                                                                                                                                                                                      
    input wire         app_data_request,                                                                                                                                                                                                                                                                                                                                    
                                                                                                                                                                                                                                                                                                                                                                                                                    
    output wire        udp_send_ready,                                                                                                                                                                                                                                                                                                                          
    output wire        udp_send_ack,                                                                                                                                                                                                                                                                                                                             
                                                                                                                                                                                                                                                                                                                                                                                                                    
    input wire         ip_send_ready,                                                                                                                                                                                                                                                                                                                             
    input wire         ip_send_ack,                                                                                                                                                                                                                                                                                                                              
    //to IP_send                                                                                                                                                                                                                                                                                                                                                                                                    
    output wire        udp_send_request,                                                                                                                                                                                                                                                                                                                                        
    output reg         udp_data_out_valid,                                                                                                                                                                                                                                                                                                                                  
    output reg [7:0]   udp_data_out,                                                                                                                                                                                                                                                                                                                                               
    output reg [15:0]  udp_packet_length                                                                                                                                                                                                                                                                                                                    
);
...
//        .Q    (  shift_data_out                          ) // output [7 : 0] q
    ...
    begin
        if(~rstn) 
            udp_packet_length <= 16'h0008;       
        else
            udp_packet_length <= app_data_length + 16'h0008;       
    end
