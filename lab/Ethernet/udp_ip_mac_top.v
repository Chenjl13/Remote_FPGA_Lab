...
module udp_ip_mac_top #(
    ...
    udp_layer #(
        .LOCAL_PORT_NUM          (  LOCL_PORT                ) //parameter LOCAL_PORT_NUM = 16'hf000    
    )udp_layer (                                             
        .udp_send_clk            (  rgmii_clk                ),//input              udp_send_clk,                                                                                                                                                                                                                                                                                                                                                                     
        .rstn                    (  rstn                     ),//input              rstn,                                                                                                                                                                                                                                                                                                                                                              
                                                                                                                                                                                                                                                                                                                                                                                                                            
        //from software app                                                                                                                                                                                                                                                                                                                                                                                                   
        .app_data_in_valid       (  app_data_in_valid        ),//input              app_data_in_valid,                                                                                                                                                                                                                                                                                                                           
        .app_data_in             (  app_data_in              ),//input      [7:0]   app_data_in,                                                                                                                                                                                                                                                                                                                                                     
        .app_data_length         (  app_data_length          ),//input      [15:0]  app_data_length,                                                                                                                                                                                                                                                                                                     
        .udp_dest_port           (  DEST_PORT                ),//input      [15:0]  udp_dest_port,                                                                                                                                                                                                                                                                                                                                        
        .app_data_request        (  app_data_request         ),//input              app_data_request,                                                                                                                                                                                                                                                                                                                                             
                                                                                                                                                                                                                                                                                                                                                                                                                             
        .udp_send_ack            (  udp_send_ack             ),//output             udp_send_ack,                                                                                                                                                                                                                                                                                                                                    
                                                                                                                                                                                                                                                                                                                                                                                                   
        .udp_send_ready          (  udp_tx_ready             ),//output          udp_send_ready,                                                                                                                                                                                                                                                                                                                                                                                             
        .ip_send_ready           (  upper_data_req           ),//input           ip_send_ready,                                                                                                                                                                                                                                                                                                                                      
        .ip_send_ack             (  udp_tx_ack               ),//input           ip_send_ack,                                                                                                                                                                                                                                                                                                                                         
        //to IP_send                                                                                                                                                                                                                                                                                                                                                                                                          
        .udp_send_request        (  udp_tx_req               ),//output          udp_send_request,                                                                                                                                                                                                                                                                                                                                                 
        .udp_data_out_valid      (                           ),//output          udp_data_out_valid,                                                                                                                                                                                                                                                                                                                                             
        .udp_data_out            (  udp_tx_data              ),//output  [7:0]   udp_data_out,                                                                                                                                                                                                                                                                                                                                                                
        .udp_packet_length       (  udp_send_data_length     ),//output  [15:0]  udp_packet_length,          
